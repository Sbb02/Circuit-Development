...
initial
begin
   test_vals[0] = 12'h0_2_A;
   test_vals[1] = 12'h0_0_5;
   test_vals[2] = 12'hB_1_B;
   test_vals[3] = 12'h0_2_F;
   test_vals[4] = 12'h0_0_A;
   test_vals[5] = 12'hA_1_A;
   test_vals[6] = 12'hA_0_C;
   test_vals[7] = 12'hA_0_D;
end
